    ...
    <div class="main-wrapper">
      ...
      <div class="nav-header bg-white shadow-xs border-0">
        <div class="nav-top">
          ...
          <a class="mob-menu ms-auto me-2 chat-active-btn"
            ><i
              class="
          ...
          <a class="mob-menu me-2"
            ...
            ></i
          ></a>
          <a class="me-2 menu-search-icon mob-menu"
            ><i
              class="
                feather-search
                text-grey-900
        ...
        <router-link
          ...
          ></i
        ></router-link>
        <a class="p-2 text-center ms-0 menu-icon center-menu-icon"
          ><i
            class="
              feather-zap
              font-lg
          ...
          <div class="nav-content">
            ...
            >
              ...
              <ul class="mb-1 top-content">
                ...
                <li>
                  <a class="nav-content-bttn open-font"
                    ><i
                      class="feather-globe btn-round-md bg-gold-gradiant me-3"
                    ></i
                    ><span>Explore Stories</span></a
                  >
                </li>
                <li>
                  <a class="nav-content-bttn open-font"
            ...
            >
              ...
              <ul class="mb-3">
                <li>
                  <a class="nav-content-bttn open-font"
                    ><i class="font-xl text-current feather-inbox me-3"></i
                    ><span>Email Box</span
                    ><span class="circle-count bg-warning mt-1">584</span></a
                  >
                </li>
                <li>
                  <a class="nav-content-bttn open-font"
                    ><i class="font-xl text-current feather-home me-3"></i
                    ><span>Near Hotel</span></a
                  >
                </li>
                <li>
                  <a class="nav-content-bttn open-font"
                    ><i class="font-xl text-current feather-map-pin me-3"></i
                    ><span>Latest Event</span></a
                  >
                </li>
                <li>
                  <a class="nav-content-bttn open-font"
                    ><i class="font-xl text-current feather-youtube me-3"></i
          ...
          <div class="modal-body p-0">
            <div
              class="
                ...
                rounded-3
                overflow-hidden
                bg-gradiant-bottom bg-gradiant-top
              "
            >
              <div
                class="
      ...
      <div class="modal-popup-wrap bg-white p-0 shadow-lg rounded-3">
        <div class="modal-popup-header w-100 border-bottom">
          <div class="card p-3 d-block border-0 d-block">
            ...
            <a class="font-xssss position-absolute right-0 top-0 mt-3 me-4"
        ...
        <div class="modal-popup-body w-100 p-3 h-auto">
          ...
          <div
            class="date-break font-xsssss lh-24 fw-500 text-grey-500 mt-2 mb-2"
          >
            Mon 10:20am
          </div>
